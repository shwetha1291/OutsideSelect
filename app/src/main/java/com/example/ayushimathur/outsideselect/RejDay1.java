...
public class RejDay1 extends Activity {
    // Progress Dialog
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fav_day2);
...
//                        break;
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                switch (index) {
                    case 0:
                        ...
                        SelectArtist.rejectedArtists1.remove(position);
    ...
    class LoadInbox extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            for (int i = 0; i < SelectArtist.rejectedArtists1.length() ; i++) {
